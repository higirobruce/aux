...
export default function LandingPage() {
  return (
    <main className="min-h-screen px-6 py-24 max-w-4xl mx-auto">
      <p className="font-mono text-xs tracking-widest uppercase text-ink-3 mb-4">aux · v0.1</p>
      ...
      <p className="text-xl text-ink-2 max-w-2xl leading-relaxed mb-10">
        A pure mixing &amp; mastering studio for the web. No arrangement, no MIDI, no instruments —
        you bring the stems, aux brings the room, the meters, and the delivery.
      </p>
